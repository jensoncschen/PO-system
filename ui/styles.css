...
@media (max-width: 768px) {
    /* 手機版：篩選方塊固定兩欄並列，避免單欄下拉太長 */
    div[data-testid="stExpander"] div[data-testid="column"] {
        flex: 0 0 calc(50% - 0.42rem) !important;
        min-width: calc(50% - 0.42rem) !important;
        width: calc(50% - 0.42rem) !important;
    }
